...
(defcustom dotemacs-eshell/plan9
  nil
  "Turn on Plan9 style prompt in eshell when non-nil."
  :group 'dotemacs-eshell)

(defucstom dotemacs-eshell/prompt-git-stats
  t
...
(when (executable-find "fortune")
  (defadvice eshell (before advice-for-eshell activate)
    (setq eshell-banner-message (concat (eshell-command-to-string "fortune") "\n"))))
